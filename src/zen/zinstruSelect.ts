...
//     console.log(`Instrument set to: ${states.currentInstrumentName}`)
...
//         console.log("Instrument default: Instant release");
//         toggleStopAudioWhenReleased(true);
//     } 
//     else {
//         console.log(states.currentInstrumentName);
//         console.log("Instrument default: Smooth release");
