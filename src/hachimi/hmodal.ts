...
export function toggleModal(show:boolean, mode = "controls") {
    ...
    if (show) {
        ...
        if (mode === "controls" || mode === "changelog" || mode === "statistics" || mode === "debug" || mode === "customise") {
